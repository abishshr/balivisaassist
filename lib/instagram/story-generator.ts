...
export async function generateStoryImage(
  ...
  const textSvg = `
    <svg width="${STORY_WIDTH}" height="${STORY_HEIGHT}">
      <style>
        .line1 { fill: white; font-size: 52px; font-weight: 700; font-family: sans-serif; }
        .line2 { fill: #e0e0e0; font-size: 36px; font-weight: 400; font-family: sans-serif; }
        .cta { fill: #00D4AA; font-size: 32px; font-weight: 700; font-family: sans-serif; }
        .brand { fill: rgba(255,255,255,0.7); font-size: 24px; font-weight: 600; font-family: sans-serif; }
      </style>
