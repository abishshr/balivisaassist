...
export const manualVisaNewsItems: VisaNews[] = [
  ...
  {
    id: 'news-008',
    title: 'B1 Extension Now Requires Biometric Data Collection',
    description: 'New procedure: B1 extensions must be done in person at immigration offices for fingerprint and photo collection. Apply 14 days before expiry.',
    date: '2026-02-05',
    category: 'alert',
  },
  {
    id: 'news-002',
    title: 'Reminder: B1 Extension Must Be Done 14 Days Before Expiry',
    description: 'Don\'t wait until the last minute! Apply for your B1 extension between 14 days and 1 business day before expiry. Overstay penalty: IDR 1M/day.',
    date: '2026-02-01',
    category: 'reminder',
  },
  {
