...
export const services: Service[] = [
  ...
  {
    id: 'b1-visa',
    name: 'B1 Visa (Visa on Arrival)',
    slug: 'b1-visa',
    shortDescription: '30-day visa on arrival, extendable once for 30 more days (60 days total)',
    description: 'The B1 Visa on Arrival is the simplest and fastest way to enter Indonesia. Available at all major airports and online (e-VOA), it allows you to stay for 30 days and can be extended once for another 30 days (60 days total). Perfect for tourists and short-term visitors.',
    ...
    requirements: [
      ...
      'Digital passport photo (for e-B1)',
    ...
    process: [
      {
        ...
        description: 'Apply online at evisa.imigrasi.go.id OR pay on arrival at the airport B1 counter.',
      },
      {
        step: 2,
        title: 'Payment & Approval',
        description: 'Pay IDR 500,000 online (Mastercard/Visa/JCB) or at airport counter. E-B1 processed immediately.',
      },
      {
        step: 3,
        title: 'Arrival & Immigration',
        description: 'Present your e-B1 approval or payment receipt at immigration. Get your passport stamped for 30 days.',
      },
      {
        step: 4,
        title: 'Extension (Optional)',
    ...
    faqs: [
      ...
      {
        question: 'Which nationalities are eligible for B1?',
      ...
      },
      {
        ...
        answer: 'Both options cost IDR 500,000. Online e-B1 is faster and more convenient. At-airport B1 may have longer queues but is fine if you prefer to pay on arrival.',
      },
      {
  ...
  },
  {
    ...
    name: 'B1 Extension',
    slug: 'b1-extension',
    shortDescription: 'Extend your B1 Visa on Arrival by 30 additional days (60 days total)',
    description: 'Need more time in Bali? We handle the entire B1 extension process for you - from application to biometric appointment scheduling at the immigration office. Extend your stay by 30 additional days without the hassle of dealing with bureaucracy.',
    ...
    requirements: [
      'Valid B1 stamp in passport',
      'Passport with minimum 6 months validity',
      'Apply at least 14 days before B1 expiry',
    ...
    process: [
      {
        step: 1,
        title: 'Contact Us',
        description: 'Reach out via WhatsApp with your passport details and current B1 information.',
      },
      {
        step: 2,
    ...
    faqs: [
      {
        question: 'When should I apply for a B1 extension?',
        answer: 'Apply between 14 days before and 1 business day before your B1 expiry date. We recommend applying as early as possible to ensure timely processing.',
      },
      {
      ...
      {
        question: 'Can I extend the B1 more than once?',
        answer: 'No, the B1 can only be extended once for 30 days. For longer stays, consider a C1 visa (up to 180 days) or a D12 visa.',
      },
    ],
  },
  {
